...
sendFileFromUrl(m.chat, `${result}`,`Nieh By RiyoXdz\nJangan Lupa Subscribe RIYO OFC`)
                break
case 'sewabot':
...
case 'audioyt': case 'ytaudio': {
    ...
    m.reply(mess.wait)
          ...
          sendFileFromUrl(m.chat,`${wipi}`,`Nieh By Riyo OFC\nJangan Lupa Subscribe RIYO OFC`)
break
	    case 'ppcp': {
                m.reply(mess.wait)
...
sendFileFromUrl(m.chat,`${anu.result}`,`Nieh By Riyo OFC\nJangan Lupa Subscribe RIYO OFC`)
break
case 'wolflogo':
if (!q) return m.reply(`Example : ${prefix + command} RiyoXdz`)
...
break
case 'pornhub':
if (!q) return m.reply(`Example : ${prefix + command} RiyoXdz|Riyo`)
var po = body.slice(9)
var as = po.split("|")[0];
var yu = po.split("|")[1];
...
case 'greenleaves':
case 'lolbanner':
if (!q) throw `Example : ${prefix + command} RiyoXdz`
m.reply(mess.wait)
sendFileFromUrl(m.chat, `https://x-daniapi.herokuapp.com/api/photooxy/${command}?text=${q}&apikey=DaniXFar`, `Nieh By Riyo OFC\nJangan Lupa Subscribe RIYO OFC`)
break
case 'neondevil':
case 'zeombie3d':
case 'neonlight':
...
if (!q) throw `Example : ${prefix + command} RiyoXdz`
m.reply(mess.wait)
sendFileFromUrl(m.chat, `https://x-daniapi.herokuapp.com/api/ephoto/${command}?text=${q}&apikey=DaniXFar`, `Nieh By Riyo OFC\nJangan Lupa Subscribe RIYO OFC`)
break
...
case 'tiktokwm':
 if (!q) return m.reply('Linknya?')
            ...
            .then((data) => { sendFileFromUrl(m.chat, data.result.nowatermark,`Nieh By Riyo OFC\nJangan Lupa Subscribe RIYO OFC`) })
...
break
case 'eroneko':
sendFileFromUrl(m.chat, `https://api.dhamzxploit.my.id/api/nsfw/neko`, `Nieh By Riyo OFC\nJangan Lupa Subscribe RIYO OFC`)
break
case 'neko':
sendFileFromUrl(m.chat, `https://api.dhamzxploit.my.id/api/neko`, `Nieh By Riyo OFC\nJangan Lupa Subscribe RIYO OFC`)
break
case 'futanari':
buffer = await getBuffer(`https://api.dapuhy.xyz/api/nsfw/nsfwfutanari?apikey=ApiLia`)
hisoka.sendMessage(m.chat, {image : buffer, caption : `Nieh By Riyo OFC\nJangan Lupa Subscribe RIYO OFC`}, {quoted : fgif})
break
case 'asupan':
m.reply(mess.wait)
sendFileFromUrl(m.chat, `https://api.zacros.my.id/asupan/random`, `Nieh By Riyo OFC\nJangan Lupa Subscribe RIYO OFC`)
break
case 'bocil':
case 'santuy':
case 'rikagusriani':
...
sendFileFromUrl(m.chat, `${anu.result.url}`, `Nieh By Riyo OFC\nJangan Lupa Subscribe RIYO OFC`)
break
...
case 'inori':
          ...
          sendFileFromUrl(m.chat,`${pii}`,`Nieh By Riyo OFC\nJangan Lupa Subscribe RIYO OFC)
break
case 'menu': case 'help':{
...
│• Runtime : ${runtime(process.uptime())}
│• Library : *Baileys-MD*
│• Script Dibuat Oleh Riyo OFC
│• Youtube : RIYO OFC ( Subs Yah )
╰───────────────┈ ⳹`
